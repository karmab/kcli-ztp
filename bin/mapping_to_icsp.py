...
parser.add_argument('--mapping-file', '-m', type=str, help='Path to the mapping.txt file generated by oc-mirror.',
                    required=True)
parser.add_argument('--output-dir', '-o', type=str,
                    help='Path to the output directory where icsp and catalogsource yamls will be generated.')
parser.add_argument('--stdout', '-s', action='store_true', help='Outputs result to stdout instead of file.')
parser.add_argument('--mirror-config', '-c', type=str,
                    help='Path to the oc-mirror config file, used to generate the catalogsource yaml.')
...
if args.stdout:
    ...
    print("CatalogSource written to {0}, ImageContentSourcePolicy written to {1}".format(catalogsource_filepath,
                                                                                         icsp_filepath))
