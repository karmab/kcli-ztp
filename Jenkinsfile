...
", description: ''),
    ...
    string(name: 'bmc_user', defaultValue: "root", description: ''),
    string(name: 'bmc_password', defaultValue: "calvin", description: ''),
